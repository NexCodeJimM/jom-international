...
const Features = () => {
  return (
    <section className="w-full flex-center flex-col mt-28 overflow-hidden">
      ...
      <div className="flex-row-reverse gap-16 mt-20 md:flex px-10">
        ...
        <div className="flex-col">
          <h1 className="feature_title">Aviation Excellence</h1>
          <p className="feature_desc">
      ...
      <div className="flex-row gap-16 mt-20 md:flex px-10">
        ...
        <div className="flex-col">
          <h1 className="feature_title">Dynamic Trading</h1>
          <p className="feature_desc">
